...
export class ViewVrednovanjeService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/view-vrednovanjes','otvoreni');
  public resourceUrlPostupak = this.applicationConfigService.getEndpointFor('api/vrednovanje','otvoreni');
  public resourceUrlVrednovanjeSifraPonude = this.applicationConfigService.getEndpointFor('api/vrednovanje-ponude','otvoreni');
